import { BigintIsh, Token } from '@liuqiang1357/uniswap-sdk-core'
import { Interface } from '@ethersproject/abi'
import json from '@uniswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
